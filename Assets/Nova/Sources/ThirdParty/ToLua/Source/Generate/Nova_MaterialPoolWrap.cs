...
public class Nova_MaterialPoolWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Nova.MaterialPool), typeof(UnityEngine.MonoBehaviour));
	...
	static int Get(IntPtr L)
	{
		try
		{
			...
			Nova.MaterialPool obj = (Nova.MaterialPool)ToLua.CheckObject<Nova.MaterialPool>(L, 1);
	...
	static int Ensure(IntPtr L)
	{
		try
		{
			...
			Nova.MaterialPool o = Nova.MaterialPool.Ensure(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int get_factory(IntPtr L)
	{
		...
		try
		{
			...
			Nova.MaterialPool obj = (Nova.MaterialPool)o;
